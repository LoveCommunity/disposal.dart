...
void main() {
  ...
  test('disposable addWith before and after dispose', () {
  ...
  test('disposable addWith before dispose', () {
  ...
  test('disposable addWith after dispose', () {
  ...
  test('disposable addWith nothing', () {
